...
export default function GoToPlans() {
  return (
    <a href='#planes' className='z-10 fixed bottom-5 self-center bg-green-100 border border-secondary rounded-full px-5 py-2.5 text-secondary hover:scale-110 duration-150 ease-in-out hover:bg-accent hover:text-primary hover:border-primary flex justify-center items-center gap-2.5 group'>
