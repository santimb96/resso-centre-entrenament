  ...
  return (
    <footer id='footer' className='w-full flex flex-col items-center mt-auto'>
      ...
      <div className='w-full text-pretty text-center font-thin text-[0.75rem] flex justify-center items-center gap-2.5 mt-2.5 mb-5'>
        <p>Web desarrollada por <Link className='underline hover:text-accent ease-in-out duration-150' href='https://smartinezdev.com' target='_blank'>Santiago Martínez</Link></p>
        <Link href='https://github.com/santimb96' target='_blank' className='hover:text-accent ease-in-out duration-150'><Github size={14} /></Link>
      </div>
    </footer>
  )
}
