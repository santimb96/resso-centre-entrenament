...
import { Calendar, ExternalLink, Location } from '../icons'
...
export default function Workshop({
  ...
  return (
    <picture className='relative w-full h-[400px] lg:h-[500px] block keen-slider__slide lg:rounded-xl lg:hover:brightness-150 lg:transition-all lg:duration-150 lg:ease-in-out'>
      <Image
      ...
      <div className='pr-5 pl-5 w-full absolute flex flex-col justify-start items-start gap-2.5 bottom-5 text-primary'>
        ...
        <div className='flex flex-col items-start justify-start gap-2.5'>
          <p className='text-[1rem] flex flex-row justify-start items-center gap-1.5 font-bold'>
