...
export default function Sponsors() {
  return (
    <section id='colaboradores' className='flex flex-col justify-center items-center py-8 px-4'>
      <div className='w-full flex flex-col items-center gap-8 md:w-[85vw] lg:w-[80vw] xl:w-[75vw] 2xl:w-[70vw]'>
